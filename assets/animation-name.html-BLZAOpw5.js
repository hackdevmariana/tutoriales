import{_ as n,o as a,c as s,d as e}from"./app-Dexr8_So.js";const i={},t=e(`<h1 id="propiedad-animation-name" tabindex="-1"><a class="header-anchor" href="#propiedad-animation-name"><span>Propiedad animation-name</span></a></h1><p>La propiedad <code>animation-name</code> en CSS se utiliza para especificar el nombre de una o más animaciones definidas con <code>@keyframes</code> que se aplicarán a un elemento.</p><h2 id="sintaxis" tabindex="-1"><a class="header-anchor" href="#sintaxis"><span>Sintaxis</span></a></h2><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>animation-name: nombre-de-la-animación;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="valores" tabindex="-1"><a class="header-anchor" href="#valores"><span>Valores</span></a></h2><ul><li><p>none: No se aplica ninguna animación.</p></li><li><p>nombre-de-la-animación: El nombre de la animación definida con <code>@keyframes</code>.</p></li></ul><h2 id="ejemplo-basico" tabindex="-1"><a class="header-anchor" href="#ejemplo-basico"><span>Ejemplo básico</span></a></h2><div class="language-css line-numbers-mode" data-ext="css" data-title="css"><pre class="language-css"><code><span class="token atrule"><span class="token rule">@keyframes</span> mover</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>En este caso, el elemento se moverá y cambiará de color simultáneamente.</p>`,13),l=[t];function p(o,c){return a(),s("div",null,l)}const r=n(i,[["render",p],["__file","animation-name.html.vue"]]),d=JSON.parse('{"path":"/css/animacion/animation-name.html","title":"Propiedad animation-name","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"Sintaxis","slug":"sintaxis","link":"#sintaxis","children":[]},{"level":2,"title":"Valores","slug":"valores","link":"#valores","children":[]},{"level":2,"title":"Ejemplo básico","slug":"ejemplo-basico","link":"#ejemplo-basico","children":[]},{"level":2,"title":"Múltiples animaciones","slug":"multiples-animaciones","link":"#multiples-animaciones","children":[]}],"git":{"updatedTime":null,"contributors":[]},"filePathRelative":"css/animacion/animation-name.md"}');export{r as comp,d as data};
