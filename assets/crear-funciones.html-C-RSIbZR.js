import{_ as n,o as a,c as s,d as e}from"./app-Q4cXS6D5.js";const c={},o=e(`<h1 id="crear-funciones" tabindex="-1"><a class="header-anchor" href="#crear-funciones"><span>Crear funciones</span></a></h1><p>Definir la función:</p><div class="language-r line-numbers-mode" data-ext="r" data-title="r"><pre class="language-r"><code>calcular_cuadrado <span class="token operator">&lt;-</span> <span class="token keyword">function</span><span class="token punctuation">(</span>x<span class="token punctuation">)</span> <span class="token punctuation">{</span>
