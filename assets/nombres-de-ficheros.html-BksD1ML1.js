import{_ as e,o as n,c as s,d as a}from"./app-CrUy1KvH.js";const t={},i=a(`<h1 id="extraer-nombre-de-fichero-y-extension" tabindex="-1"><a class="header-anchor" href="#extraer-nombre-de-fichero-y-extension"><span>Extraer nombre de fichero y extensión</span></a></h1><p>Nombre del fichero:</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> pathlib <span class="token keyword">import</span> Path
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,13),o=[i];function p(l,r){return n(),s("div",null,o)}const c=e(t,[["render",p],["__file","nombres-de-ficheros.html.vue"]]),u=JSON.parse('{"path":"/python/ficheros/nombres-de-ficheros.html","title":"Extraer nombre de fichero y extensión","lang":"en-US","frontmatter":{},"headers":[],"git":{"updatedTime":null,"contributors":[]},"filePathRelative":"python/ficheros/nombres-de-ficheros.md"}');export{c as comp,u as data};
