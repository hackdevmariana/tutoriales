import{_ as n,o as a,c as s,d as e}from"./app-CqZsgWvl.js";const t={},o=e(`<h1 id="leer-variables-de-un-fichero-yaml" tabindex="-1"><a class="header-anchor" href="#leer-variables-de-un-fichero-yaml"><span>Leer variables de un fichero yaml</span></a></h1><p>Necesitaremos instalar el módulo <code>yaml-loader</code> en el proyecto. Lo podemos hacer con <code>npm</code>:</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> --save-dev yaml-loader
