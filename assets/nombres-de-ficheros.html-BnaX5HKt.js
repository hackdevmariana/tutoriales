import{_ as e,o as n,c as a,d as s}from"./app-BUXneG8Z.js";const t={},i=s(`<h1 id="extraer-nombre-de-fichero-y-extension" tabindex="-1"><a class="header-anchor" href="#extraer-nombre-de-fichero-y-extension"><span>Extraer nombre de fichero y extensión</span></a></h1><p>Nombre del fichero:</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> pathlib <span class="token keyword">import</span> Path
