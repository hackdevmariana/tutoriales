import{_ as n,o as s,c as a,d as e}from"./app-G8bc0BdV.js";const t={},i=e(`<h1 id="cambiar-la-ruta-por-defecto-en-un-proyecto-laravel" tabindex="-1"><a class="header-anchor" href="#cambiar-la-ruta-por-defecto-en-un-proyecto-laravel"><span>Cambiar la ruta por defecto en un proyecto Laravel</span></a></h1><p>Para cambiar la ruta por defecto en un proyecto Laravel, podemos configurarla en <code>app/routes/web.php</code> que, por defecto es algo así:</p><div class="language-php line-numbers-mode" data-ext="php" data-title="php"><pre class="language-php"><code><span class="token keyword">use</span> <span class="token package">Illuminate<span class="token punctuation">\\</span>Support<span class="token punctuation">\\</span>Facades<span class="token punctuation">\\</span>Route</span><span class="token punctuation">;</span>
