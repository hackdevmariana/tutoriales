...
class \${1:ClassName}(\${2:object}):
        ...
        def __init__(self, \${4:parameters}):
                ...
                \${0:# class body}
endsnippet
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="snippets-avanzados" tabindex="-1"><a class="header-anchor" href="#snippets-avanzados"><span>snippets avanzados</span></a></h2><p>Si quieres escribir el nombre de la variable una sola vez, puedes usar una expresión de Python entre \` para asignar el valor del primer campo a una variable y luego usarla en el resto del snippet. Por ejemplo, podrías hacer algo así:</p><div class="language-snippets line-numbers-mode" data-ext="snippets" data-title="snippets"><pre class="language-snippets"><code>snippet vue &quot;Vue component&quot; b
\`!p snip.rv = t[1]\`
&lt;template&gt;
&lt;div&gt;
\${1:&lt;!-- template content --&gt;}
...
&lt;/script&gt;
endsnippet
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>De esta forma, cuando escribas el nombre del componente en el primer campo, se guardará en la variable snip.rv y se usará en el bloque <code>&lt;script&gt;</code>.</p><p>Si quieres usar un número indeterminado de variables, puedes usar la opción r en el snippet para indicar que el contenido se evalúa como una expresión regular. De esta forma, puedes usar grupos de captura para repetir el mismo patrón varias veces. Por ejemplo, podrías hacer algo así:</p><div class="language-snippets line-numbers-mode" data-ext="snippets" data-title="snippets"><pre class="language-snippets"><code>snippet props &quot;Vue props&quot; r
props: {
\`!p
import re
...
endsnippet
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>De esta forma, cuando escribas una lista de propiedades separadas por comas en el primer campo, se generarán los objetos correspondientes con el tipo y las opciones que quieras. Por ejemplo, si escribes name: String, age: Number, se generará lo siguiente:</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>props: {
name: String,
age: Number
name: {
type: String,
