import{_ as s,o as n,c as a,d as e}from"./app-Bk0pT5vL.js";const i={},t=e(`<h1 id="css-grid" tabindex="-1"><a class="header-anchor" href="#css-grid"><span>CSS Grid</span></a></h1><p>CSS Grid es un sistema de diseño que permite crear estructuras complejas de filas y columnas en una página web.</p><p>Primero, debemos definir un contenedor que utilizará el grid. Esto se hace aplicando la propiedad <code>display: grid</code> a un elemento.</p><div class="language-css line-numbers-mode" data-ext="css" data-title="css"><pre class="language-css"><code><span class="token selector">.contenedor</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>En este ejemplo, se crean áreas llamadas header, sidebar y main que ocupan diferentes partes del grid.</p>`,13),p=[t];function c(l,o){return n(),a("div",null,p)}const r=s(i,[["render",c],["__file","grid.html.vue"]]),u=JSON.parse('{"path":"/css/grid.html","title":"CSS Grid","lang":"en-US","frontmatter":{},"headers":[],"git":{"updatedTime":null,"contributors":[]},"filePathRelative":"css/grid.md"}');export{r as comp,u as data};
